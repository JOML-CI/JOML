...
public fun Matrix4dc.arcball(radius: Double, centerX: Double, centerY: Double, centerZ: Double, angleX: Angled, angleY: Angled, dest: Matrix4d): Matrix4d = arcball(radius, centerX, centerY, centerZ, angleX.radians, angleY.radians, dest)
public fun Matrix4dc.arcball(radius: Double, center: Vector3dc, angleX: Angled, angleY: Angled, dest: Matrix4d): Matrix4d = arcball(radius, center, angleX.radians, angleY.radians, dest)
...
public fun Matrix4d.rotationX(angle: Angled): Matrix4d = rotationX(angle.radians)
public fun Matrix4d.rotationY(angle: Angled): Matrix4d = rotationY(angle.radians)
public fun Matrix4d.rotationZ(angle: Angled): Matrix4d = rotationZ(angle.radians)
public fun Matrix4d.rotationXYZ(angleX: Angled, angleY: Angled, angleZ: Angled): Matrix4d = rotationXYZ(angleX.radians, angleY.radians, angleZ.radians)
public fun Matrix4d.rotationZYX(angleZ: Angled, angleY: Angled, angleX: Angled): Matrix4d = rotationZYX(angleZ.radians, angleY.radians, angleX.radians)
public fun Matrix4d.rotationYXZ(angleY: Angled, angleX: Angled, angleZ: Angled): Matrix4d = rotationYXZ(angleY.radians, angleX.radians, angleZ.radians)
public fun Matrix4d.setRotationXYZ(angleX: Angled, angleY: Angled, angleZ: Angled): Matrix4d = setRotationXYZ(angleX.radians, angleY.radians, angleZ.radians)
public fun Matrix4d.setRotationZYX(angleZ: Angled, angleY: Angled, angleX: Angled): Matrix4d = setRotationZYX(angleZ.radians, angleY.radians, angleX.radians)
public fun Matrix4d.setRotationYXZ(angleY: Angled, angleX: Angled, angleZ: Angled): Matrix4d = setRotationYXZ(angleY.radians, angleX.radians, angleZ.radians)
public fun Matrix4d.arcball(radius: Double, centerX: Double, centerY: Double, centerZ: Double, angleX: Angled, angleY: Angled): Matrix4d = arcball(radius, centerX, centerY, centerZ, angleX.radians, angleY.radians)
public fun Matrix4d.arcball(radius: Double, center: Vector3dc, angleX: Angled, angleY: Angled): Matrix4d = arcball(radius, center, angleX.radians, angleY.radians)
