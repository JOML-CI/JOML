...
public fun Matrix3dc.rotateXYZ(angleX: Angled, angleY: Angled, angleZ: Angled, dest: Matrix3d): Matrix3d =
    rotateXYZ(angleX.radians, angleY.radians, angleZ.radians, dest)
public fun Matrix3dc.rotateZYX(angleZ: Angled, angleY: Angled, angleX: Angled, dest: Matrix3d): Matrix3d =
    rotateZYX(angleZ.radians, angleY.radians, angleX.radians, dest)
public fun Matrix3dc.rotateYXZ(angleY: Angled, angleX: Angled, angleZ: Angled, dest: Matrix3d): Matrix3d =
    rotateYXZ(angleY.radians, angleX.radians, angleZ.radians, dest)
public fun Matrix3dc.rotate(angle: Angled, axis: Vector3fc, dest: Matrix3d): Matrix3d =
    rotate(angle.radians, axis, dest)
...
public fun Matrix3d.rotateXYZ(angleX: Angled, angleY: Angled, angleZ: Angled): Matrix3d =
    rotateXYZ(angleX.radians, angleY.radians, angleZ.radians)
public fun Matrix3d.rotateZYX(angleZ: Angled, angleY: Angled, angleX: Angled): Matrix3d =
    rotateZYX(angleZ.radians, angleY.radians, angleX.radians)
public fun Matrix3d.rotateYXZ(angleY: Angled, angleX: Angled, angleZ: Angled): Matrix3d =
...
public fun Matrix3d.rotation(angle: Angled, x: Double, y: Double, z: Double): Matrix3d =
