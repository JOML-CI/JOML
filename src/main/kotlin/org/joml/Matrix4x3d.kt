...
public fun Matrix4x3dc.arcball(radius: Double, centerX: Double, centerY: Double, centerZ: Double, angleX: Angled, angleY: Angled, dest: Matrix4x3d): Matrix4x3d = arcball(radius, centerX, centerY, centerZ, angleX.radians, angleY.radians, dest)
public fun Matrix4x3dc.arcball(radius: Double, center: Vector3dc, angleX: Angled, angleY: Angled, dest: Matrix4x3d): Matrix4x3d = arcball(radius, center, angleX.radians, angleY.radians, dest)
...
public fun Matrix4x3d.rotationX(angle: Angled): Matrix4x3d = rotationX(angle.radians)
public fun Matrix4x3d.rotationY(angle: Angled): Matrix4x3d = rotationY(angle.radians)
public fun Matrix4x3d.rotationZ(angle: Angled): Matrix4x3d = rotationZ(angle.radians)
public fun Matrix4x3d.rotationXYZ(angleX: Angled, angleY: Angled, angleZ: Angled): Matrix4x3d = rotationXYZ(angleX.radians, angleY.radians, angleZ.radians)
public fun Matrix4x3d.rotationZYX(angleZ: Angled, angleY: Angled, angleX: Angled): Matrix4x3d = rotationZYX(angleZ.radians, angleY.radians, angleX.radians)
public fun Matrix4x3d.rotationYXZ(angleY: Angled, angleX: Angled, angleZ: Angled): Matrix4x3d = rotationYXZ(angleY.radians, angleX.radians, angleZ.radians)
public fun Matrix4x3d.setRotationXYZ(angleX: Angled, angleY: Angled, angleZ: Angled): Matrix4x3d = setRotationXYZ(angleX.radians, angleY.radians, angleZ.radians)
public fun Matrix4x3d.setRotationZYX(angleZ: Angled, angleY: Angled, angleX: Angled): Matrix4x3d = setRotationZYX(angleZ.radians, angleY.radians, angleX.radians)
public fun Matrix4x3d.setRotationYXZ(angleY: Angled, angleX: Angled, angleZ: Angled): Matrix4x3d = setRotationYXZ(angleY.radians, angleX.radians, angleZ.radians)
public fun Matrix4x3d.arcball(radius: Double, centerX: Double, centerY: Double, centerZ: Double, angleX: Angled, angleY: Angled): Matrix4x3d = arcball(radius, centerX, centerY, centerZ, angleX.radians, angleY.radians)
public fun Matrix4x3d.arcball(radius: Double, center: Vector3dc, angleX: Angled, angleY: Angled): Matrix4x3d = arcball(radius, center, angleX.radians, angleY.radians)
