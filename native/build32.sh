...
gcc -c -msse2 -fPIC -m32 -O3 -I"$JAVA_HOME/include" -I"$JAVA_HOME/include/linux" src/org_joml_Matrix3f.c -lm -o build/org_joml_Matrix3f.o
...
gcc -c -mavx -fPIC -m32 -O3 -I"$JAVA_HOME/include" -I"$JAVA_HOME/include/linux" src/org_joml_Matrix4d.c -lm -o build/org_joml_Matrix4d.o
