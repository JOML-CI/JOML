...
JNIEXPORT void JNICALL Java_org_joml_Matrix4f_invertNativeAVX(JNIEnv* env, jclass clazz, jlong m0, jlong m1) {
	invertNative(m0, m1);
}
JNIEXPORT void JNICALL JavaCritical_org_joml_Matrix4f_invertNativeAVX(jlong m0, jlong m1) {
	invertNative(m0, m1);
}
...
JNIEXPORT void JNICALL JavaCritical_org_joml_Matrix4f_mulBatchedNativeAVX(jint count, jlong m0, jlong m1, jlong dest) {
	for (int i = 0; i < count; i++)
		mulNative(m0 + (16 << 2)*i, m1 + (16 << 2)*i, dest + (16 << 2)*i);
}
...
JNIEXPORT void JNICALL Java_org_joml_Matrix4f_mulAffineNativeAVX(JNIEnv* env, jclass clazz, jlong m0, jlong m1, jlong dest) {
	mulAffineNative(m0, m1, dest);
}
JNIEXPORT void JNICALL JavaCritical_org_joml_Matrix4f_mulAffineNativeAVX(jlong m0, jlong m1, jlong dest) {
	mulAffineNative(m0, m1, dest);
}

JNIEXPORT void JNICALL Java_org_joml_Matrix4f_mulAffineBatchedNativeAVX(JNIEnv* env, jclass clazz, jint count, jlong m0, jlong m1, jlong dest) {
	for (int i = 0; i < count; i++)
		mulAffineNative(m0 + (16 << 2)*i, m1 + (16 << 2)*i, dest + (16 << 2)*i);
}
JNIEXPORT void JNICALL JavaCritical_org_joml_Matrix4f_mulAffineBatchedNativeAVX(jint count, jlong m0, jlong m1, jlong dest) {
	for (int i = 0; i < count; i++)
		mulAffineNative(m0 + (16 << 2)*i, m1 + (16 << 2)*i, dest + (16 << 2)*i);
}
...
JNIEXPORT void JNICALL Java_org_joml_Matrix4f_rotateAngleXYZAVX(JNIEnv* env, jclass clazz, jfloat angle, jfloat x, jfloat y, jfloat z, jlong src, jlong dst) {
	rotateAngleXYZ((float)angle, (float)x, (float)y, (float)z, (const float*)(intptr_t)src, (float*)(intptr_t)dst);
}
JNIEXPORT void JNICALL JavaCritical_org_joml_Matrix4f_rotateAngleXYZAVX(jfloat angle, jfloat x, jfloat y, jfloat z, jlong src, jlong dst) {
	rotateAngleXYZ((float)angle, (float)x, (float)y, (float)z, (const float*)(intptr_t)src, (float*)(intptr_t)dst);
}
