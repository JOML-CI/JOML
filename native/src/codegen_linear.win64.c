...
static const unsigned char actionlist[1451] = {
  ...
  255,76,139,1,72,131,193,16,65,15,40,0,73,199,193,0,0,0,128,102,73,15,110,
  201,15,198,201,0,15,87,193,65,15,41,0,255,85,72,137,229,72,129,252,236,239,
  255,252,243,68,15,127,60,36,252,243,68,15,127,180,253,36,233,252,243,68,15,
  127,172,253,36,233,252,243,68,15,127,164,253,36,233,252,243,68,15,127,156,
  253,36,233,252,243,68,15,127,148,253,36,233,252,243,68,15,127,140,253,36,
  233,252,243,68,15,127,132,253,36,233,252,243,15,127,188,253,36,233,252,243,
  15,127,180,253,36,233,255,252,243,68,15,111,60,36,252,243,68,15,111,180,253,
...
static void prologue(dasm_State** Dst) {
  ...
  //| mov rbp, rsp
  //| sub rsp, 16*10
  dasm_put(Dst, 1261, 16*10);
#line 484 "codegen_linear.dasc"
  ...
  dasm_put(Dst, 1271, 4*4, 4*4*2, 4*4*3, 4*4*4, 4*4*5, 4*4*6, 4*4*7, 4*4*8, 4*4*9);
...
static void epilogue(dasm_State** Dst) {
  ...
  //| pop rbp
  //| ret
  dasm_put(Dst, 1358, 4*4, 4*4*2, 4*4*3, 4*4*4, 4*4*5, 4*4*6, 4*4*7, 4*4*8, 4*4*9);
#line 511 "codegen_linear.dasc"
}
