...
static const unsigned char actionlist[1158] = {
...
#line 379 "codegen_linear.dasc"
  ...
  dasm_put(Dst, 978, 4*4, 4*4*2, 4*4*3, 4*4*4, 4*4*5, 4*4*6, 4*4*7, 4*4*8, 4*4*9);
#line 390 "codegen_linear.dasc"
}
...
static void epilogue(dasm_State** Dst) {
  ...
  //| pop rbp
  //| ret
  dasm_put(Dst, 1065, 4*4, 4*4*2, 4*4*3, 4*4*4, 4*4*5, 4*4*6, 4*4*7, 4*4*8, 4*4*9);
#line 406 "codegen_linear.dasc"
}
