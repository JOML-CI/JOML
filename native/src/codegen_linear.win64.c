#line 185 "codegen_linear.dasc"
  if (!storeIntoSecond) {
    //| movaps xmm9, xmm3
    //| movaps xmm10, xmm4
    dasm_put(Dst, 434);
#line 188 "codegen_linear.dasc"
  } else {
    //| movaps xmm12, xmm8
    //| movaps xmm13, xmm3
    //| movaps xmm14, xmm4
...
static void matrix_rotateY(dasm_State** Dst, char storeIntoSecond) {
  ...
  //| mulps xmm5, xmm1 // m2X * rm22
  //| addps xmm4, xmm5
  dasm_put(Dst, 463, _MM_SHUFFLE(0, 0, 0, 0), _MM_SHUFFLE(0, 0, 0, 0));
#line 217 "codegen_linear.dasc"
  if (!storeIntoSecond) {
    //| movaps xmm8, xmm3
    //| movaps xmm10, xmm4
    dasm_put(Dst, 532);
#line 220 "codegen_linear.dasc"
  } else {
    //| movaps xmm12, xmm3
    //| movaps xmm13, xmm9
    //| movaps xmm14, xmm4
...
static void matrix_rotateZ(dasm_State** Dst, char storeIntoSecond) {
  ...
  //| addps xmm4, xmm5
  dasm_put(Dst, 561, _MM_SHUFFLE(0, 0, 0, 0), _MM_SHUFFLE(0, 0, 0, 0));
#line 249 "codegen_linear.dasc"
  if (!storeIntoSecond) {
    //| movaps xmm8, xmm3
    //| movaps xmm9, xmm4
    dasm_put(Dst, 630);
...
static void matrix_scale(dasm_State** Dst, char storeIntoSecond) {
  ...
  //| movaps xmm2, xmm8
  //| mulps xmm2, xmm1
  dasm_put(Dst, 699, _MM_SHUFFLE(0, 0, 0, 0));
#line 283 "codegen_linear.dasc"
  if (!storeIntoSecond) {
    //| movaps xmm8, xmm2
    dasm_put(Dst, 721);
#line 285 "codegen_linear.dasc"
  } else {
    //| movaps xmm12, xmm2
    dasm_put(Dst, 726);
#line 287 "codegen_linear.dasc"
  }
  //| movaps xmm1, xmm0
  //| shufps xmm1, xmm1, _MM_SHUFFLE(1, 1, 1, 1)
  //| movaps xmm2, xmm9
  //| mulps xmm2, xmm1
  dasm_put(Dst, 731, _MM_SHUFFLE(1, 1, 1, 1));
#line 292 "codegen_linear.dasc"
  if (!storeIntoSecond) {
    //| movaps xmm9, xmm2
    dasm_put(Dst, 746);
#line 294 "codegen_linear.dasc"
  } else {
    //| movaps xmm13, xmm2
    dasm_put(Dst, 751);
#line 296 "codegen_linear.dasc"
  }
  //| movaps xmm1, xmm0
  //| shufps xmm1, xmm1, _MM_SHUFFLE(2, 2, 2, 2)
  //| movaps xmm2, xmm10
  //| mulps xmm2, xmm1
  dasm_put(Dst, 757, _MM_SHUFFLE(2, 2, 2, 2));
...
static void matrix_translate(dasm_State** Dst, char storeIntoSecond) {
  ...
  //| movaps xmm1, xmm11
  //| addps xmm2, xmm1 // + m3N
  dasm_put(Dst, 788, _MM_SHUFFLE(0, 0, 0, 0), _MM_SHUFFLE(1, 1, 1, 1), _MM_SHUFFLE(2, 2, 2, 2));
#line 331 "codegen_linear.dasc"
  if (!storeIntoSecond) {
    //| movaps xmm11, xmm2
    dasm_put(Dst, 851);
#line 333 "codegen_linear.dasc"
  } else {
    //| movaps xmm12, xmm8
    //| movaps xmm13, xmm9
    //| movaps xmm14, xmm10
...
#line 344 "codegen_linear.dasc"
  ...
  dasm_put(Dst, 881, 4*16*10, 4*16, 4*16*2, 4*16*3, 4*16*4, 4*16*5, 4*16*6, 4*16*7, 4*16*8, 4*16*9);
#line 356 "codegen_linear.dasc"
}
...
static void epilogue(dasm_State** Dst) {
  ...
  //| pop rbp
  //| ret
  dasm_put(Dst, 973, 4*16, 4*16*2, 4*16*3, 4*16*4, 4*16*5, 4*16*6, 4*16*7, 4*16*8, 4*16*9, 4*16*10);
#line 373 "codegen_linear.dasc"
}
