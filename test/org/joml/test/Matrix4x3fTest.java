...
import org.joml.api.matrix.Matrix4x3fc;
...
public class Matrix4x3fTest extends TestCase {
    ...
    public static void testPositiveXYZSameAsInvert() {
        ...
        Matrix4x3fc m = new Matrix4x3f().rotateXYZ(0.12f, 1.25f, -2.56f);
        Matrix4x3fc inv = new Matrix4x3f(m).invert();
        m.positiveX(dir);
    ...
    public static void testNormal() {
        Matrix4x3fc r = new Matrix4x3f().rotateY((float) Math.PI / 2);
        Matrix4x3fc s = new Matrix4x3f(r).scale(0.2f);
    ...
    public static void testRotateXYZ() {
        Matrix4x3fc m = new Matrix4x3f().rotateX(0.12f).rotateY(0.0623f).rotateZ(0.95f);
        Matrix4x3fc n = new Matrix4x3f().rotateXYZ(0.12f, 0.0623f, 0.95f);
        TestUtil.assertMatrix4x3fEquals(m, n, 1E-6f);
    }

    public static void testRotateZYX() {
        Matrix4x3fc m = new Matrix4x3f().rotateZ(1.12f).rotateY(0.0623f).rotateX(0.95f);
        Matrix4x3fc n = new Matrix4x3f().rotateZYX(1.12f, 0.0623f, 0.95f);
        TestUtil.assertMatrix4x3fEquals(m, n, 1E-6f);
    }

    public static void testRotateYXZ() {
        Matrix4x3fc m = new Matrix4x3f().rotateY(1.12f).rotateX(0.0623f).rotateZ(0.95f);
        Matrix4x3fc n = new Matrix4x3f().rotateYXZ(1.12f, 0.0623f, 0.95f);
        TestUtil.assertMatrix4x3fEquals(m, n, 1E-6f);
    }
    ...
    public static void testRotationXYZ() {
        Matrix4x3fc m = new Matrix4x3f().rotationX(0.32f).rotateY(0.5623f).rotateZ(0.95f);
        Matrix4x3fc n = new Matrix4x3f().rotationXYZ(0.32f, 0.5623f, 0.95f);
        TestUtil.assertMatrix4x3fEquals(m, n, 1E-6f);
    }

    public static void testRotationZYX() {
        Matrix4x3fc m = new Matrix4x3f().rotationZ(0.12f).rotateY(0.0623f).rotateX(0.95f);
        Matrix4x3fc n = new Matrix4x3f().rotationZYX(0.12f, 0.0623f, 0.95f);
        TestUtil.assertMatrix4x3fEquals(m, n, 1E-6f);
    }

    public static void testRotationYXZ() {
        Matrix4x3fc m = new Matrix4x3f().rotationY(0.12f).rotateX(0.0623f).rotateZ(0.95f);
        Matrix4x3fc n = new Matrix4x3f().rotationYXZ(0.12f, 0.0623f, 0.95f);
        TestUtil.assertMatrix4x3fEquals(m, n, 1E-6f);
    }
